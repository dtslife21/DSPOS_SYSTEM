...
//       display: 'flex',
//       backgroundImage: `url(${require('../../assets/images/products/login.png')})`,
...
//   const checkSuccessLogin = useSelector((state) => state.auth.isLoggedIn); 
      ...
      <Box sx={styles.root}>
        <Box sx={styles.loginBox}>
          ...
          >
            ...
            <img 
              src={require('../../assets/images/products/metrologo.png')}
              alt="Company Logo" 
          ...
          <Typography
            ...
            sx={{ mt: 2 }}
          >
            © 2025 Dockyard Software. All rights reserved.
          </Typography>
