...
//   const { numSelected, handleAddNewGRN } = props;
...
//           handleAddNewGRN={handleAddNewGRN}
//         />
...
//           />
//         </Box>
//         <Box mt={2} display="flex" justifyContent="flex-end" alignItems="flex-end" pr={2}>
          ...
          <TableBody>
            {grnData.map((row) => (
              <TableRow key={row.id} hover>
                ...
                <TableCell>{row.originatedBy}</TableCell>
                <TableCell>
                  <span
                    style={{
                      padding: '4px 8px',
